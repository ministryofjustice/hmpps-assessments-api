...
('57099ea6-37e0-441e-9d05-ca840d225261', 'gp_first_name', 'UPW', 'DELIUS', '$[?(@.relationshipType.code==''RT02'')].firstName', null, 'secure/offenders/crn/$crn/personalContacts', null, false),
('a9ec6f88-58ad-4339-8969-3c27a62c85db', 'gp_family_name', 'UPW', 'DELIUS', '$[?(@.relationshipType.code==''RT02'')].surname', null, 'secure/offenders/crn/$crn/personalContacts', null, false),
('8b7c2dac-620a-4fd9-9f78-016ed53511a4', 'gp_address_building_name', 'UPW', 'DELIUS', '$[?(@.relationshipType.code==''RT02'')].address.buildingName', null, 'secure/offenders/crn/$crn/personalContacts', null, false),
('873c2901-6f23-4a7f-b230-fafba2819faf', 'gp_address_house_number', 'UPW', 'DELIUS', '$[?(@.relationshipType.code==''RT02'')].address.addressNumber', null, 'secure/offenders/crn/$crn/personalContacts', null, false),
('b1c76706-8634-43c9-8c70-67b78976d672', 'gp_address_street_name', 'UPW', 'DELIUS', '$[?(@.relationshipType.code==''RT02'')].address.streetName', null, 'secure/offenders/crn/$crn/personalContacts', null, false),
('4283f9e3-0ec5-4f40-831c-0c93160d5c43', 'gp_address_district', 'UPW', 'DELIUS', '$[?(@.relationshipType.code==''RT02'')].address.district', null, 'secure/offenders/crn/$crn/personalContacts', null, false),
('7501f047-2836-4bb8-8e03-54ab40543a8b', 'gp_address_town_or_city', 'UPW', 'DELIUS', '$[?(@.relationshipType.code==''RT02'')].address.town', null, 'secure/offenders/crn/$crn/personalContacts', null, false),
('926c91e1-d020-4b16-9040-acd9b0dc1d53', 'gp_address_county', 'UPW', 'DELIUS', '$[?(@.relationshipType.code==''RT02'')].address.county', null, 'secure/offenders/crn/$crn/personalContacts', null, false),
('7762598e-dc3c-41a4-8546-38444c0ef708', 'gp_address_postcode', 'UPW', 'DELIUS', '$[?(@.relationshipType.code==''RT02'')].address.postcode', null, 'secure/offenders/crn/$crn/personalContacts', null, false),
('7802580e-fa85-4998-966e-cc29e58f04a5', 'gp_phone_number', 'UPW', 'DELIUS', '$[?(@.relationshipType.code==''RT02'')].address.telephoneNumber', null, 'secure/offenders/crn/$crn/personalContacts', null, false),
