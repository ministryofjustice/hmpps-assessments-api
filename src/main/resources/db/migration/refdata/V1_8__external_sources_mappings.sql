...
('62bbedfd-8653-42ee-a43a-52e9fb46c61c', 'upw_employment_education_details_fulltime', 'UPW', 'DELIUS', '$.personalCircumstances[?(@.personalCircumstanceType.code==''B'' && (@.personalCircumstanceSubType.code==''B01C'' || @.personalCircumstanceSubType.code==''B01D'' || @.personalCircumstanceSubType.code==''B04A'' || @.personalCircumstanceSubType.code==''B04B'' || @.personalCircumstanceSubType.code==''B03A''))].personalCircumstanceSubType.code', null, 'secure/offenders/crn/$crn/personalCircumstances'),
('06119b94-109a-4e13-8a41-bd380d502ad6', 'upw_employment_education_details_parttime', 'UPW', 'DELIUS', '$.personalCircumstances[?(@.personalCircumstanceType.code==''B'' && (@.personalCircumstanceSubType.code==''B02C'' || @.personalCircumstanceSubType.code==''B02D'' || @.personalCircumstanceSubType.code==''B05A'' || @.personalCircumstanceSubType.code==''B05B'' || @.personalCircumstanceSubType.code==''B03B''))].personalCircumstanceSubType.code', null, 'secure/offenders/crn/$crn/personalCircumstances'),
('89b627fb-c938-4721-990c-9fc8faac5e6b', 'upw_employment_education', 'UPW', 'DELIUS', '$.personalCircumstances[?(@.personalCircumstanceType.code==''B'' && (@.personalCircumstanceSubType.code==''B09A'' || @.personalCircumstanceSubType.code==''B09B'' || @.personalCircumstanceSubType.code==''B13'' || @.personalCircumstanceSubType.code==''B14A'' || @.personalCircumstanceSubType.code==''B14B''))].personalCircumstanceSubType.code', null, 'secure/offenders/crn/$crn/personalCircumstances'),
