...
('be7794a5-1025-4ee5-bf36-c49fa5cc2acf', 'contact_phone_number', 'UPW', 'DELIUS', '$.contactDetails.addresses[?(@.status.code==''M'')].telephoneNumber', 'array', 'secure/offenders/crn/$crn/all'),
...
('d48a7841-8398-4964-8fa9-30b932191296', 'upw_caring_commitments', 'UPW', 'DELIUS', '$.personalCircumstances[?(@.personalCircumstanceType.code==''I'')].personalCircumstanceSubType.description', null, 'secure/offenders/crn/$crn/personalCircumstances'),
