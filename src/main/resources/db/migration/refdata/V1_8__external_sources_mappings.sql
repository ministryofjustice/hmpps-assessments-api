...
('5abb0441-57ee-4049-ad52-b4c5d34750dc', 'main_address_building_name', 'UPW', 'DELIUS', '$.contactDetails.addresses[?(@.status.code==''M'')].buildingName', null),
('3da78bdf-b50e-4e1c-b762-8dc6231d9ec4', 'main_address_house_number', 'UPW', 'DELIUS', '$.contactDetails.addresses[?(@.status.code==''M'')].addressNumber', null),
('7c97401a-51ef-4ea6-abf7-ab4afebba592', 'main_address_street_name', 'UPW', 'DELIUS', '$.contactDetails.addresses[?(@.status.code==''M'')].streetName', null),
('48a72e06-7115-4ba3-978a-53350d0610af', 'main_address_district', 'UPW', 'DELIUS', '$.contactDetails.addresses[?(@.status.code==''M'')].district', null),
('390135d2-9bc1-4b78-9f87-09a450c4cb48', 'main_address_town_city', 'UPW', 'DELIUS', '$.contactDetails.addresses[?(@.status.code==''M'')].town', null),
('a0a3b08b-0084-44a4-b7df-380542337b83', 'main_address_county', 'UPW', 'DELIUS', '$.contactDetails.addresses[?(@.status.code==''M'')].county', null),
('cc315d63-ddfa-4959-bb68-fd9a4be08a24', 'main_address_postcode', 'UPW', 'DELIUS', '$.contactDetails.addresses[?(@.status.code==''M'')].postcode', null),
