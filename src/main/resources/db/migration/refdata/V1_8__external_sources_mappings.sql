...
('725be246-81fe-4b5c-9042-2e3cf7e2dc9', 'main_address_district', 'UPW', 'DELIUS', '$.contactDetails.addresses[?(@.status.code==''M'')].addressNumber', null),
('4696ece6-666b-44e1-8015-f417bdff26a', 'main_address_town_city', 'UPW', 'DELIUS', '$.contactDetails.addresses[?(@.status.code==''M'')].streetName', null),
('a9ee6269-b4dc-4e4d-8b34-068262dccaf', 'main_address_county', 'UPW', 'DELIUS', '$.contactDetails.addresses[?(@.status.code==''M'')].addressNumber', null),
('f3fada26-59b0-484b-bb61-9c0446245d2', 'main_address_postcode', 'UPW', 'DELIUS', '$.contactDetails.addresses[?(@.status.code==''M'')].streetName', null),
