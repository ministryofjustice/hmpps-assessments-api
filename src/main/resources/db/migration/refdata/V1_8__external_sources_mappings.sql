...
-- ('d6920b7b-927e-407a-b96c-a738d92b0bee', 'learning_disability', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''LA'')].disabilityType.code', 'array', 'secure/offenders/crn/$crn/all', null, false),
-- ('27a0cc22-a876-4123-9a34-56363d4ce24f', 'learning_disability_details', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''LA'')].disabilityType.description', 'array', 'secure/offenders/crn/$crn/all', null, false),
-- ('7cad64f6-898d-4e2f-a466-6d660b76380b', 'learning_difficulty', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''LD'')].disabilityType.code', 'array', 'secure/offenders/crn/$crn/all', null, false),
-- ('0a8f5e55-1223-4912-94a7-7fad8dc28368', 'learning_difficulty_details', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''LD'')].disabilityType.description', 'array', 'secure/offenders/crn/$crn/all', null, false),
-- ('12be7d28-b20e-43f3-ba3b-3d0fd302e63a', 'mental_health_condition', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''D''|| @.disabilityType.code==''D01'' || @.disabilityType.code==''MI'')].disabilityType.code', 'array', 'secure/offenders/crn/$crn/all', null, false),
-- ('031e620a-b49a-4371-931b-6d6e05c3af4d', 'mental_health_condition_details', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''D''|| @.disabilityType.code==''D01'' || @.disabilityType.code==''MI'')].disabilityType.description', 'array', 'secure/offenders/crn/$crn/all', null, false),
(

--  TODO add autistic spectrum disorder, other
 '8e1dca63-0094-4515-a17e-5e552bedd637', 'dyslexia_disability', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''DY'')]', 'structured', 'secure/offenders/crn/$crn/all', null, false),
('20ed6bb6-33cf-4b2d-83a0-99fa5211ebd8', 'visual_disability', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''VI'')]', 'structured', 'secure/offenders/crn/$crn/all', null, false),
('51a0e59f-2d52-4c91-b90b-21640b5ba915', 'speech_disability', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''SI'')]', 'structured', 'secure/offenders/crn/$crn/all', null, false),
('358b6c13-3ff5-4184-8865-fc6721936d25', 'hearing_disability', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''HD'')]', 'structured', 'secure/offenders/crn/$crn/all', null, false),
('6ec9aae0-0950-4701-99b0-1589584197b0', 'learning_disability', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''LD''|| @.disabilityType.code==''LA'')]', 'structured', 'secure/offenders/crn/$crn/all', null, false),
('0f01a375-903d-4707-ade7-1d8c331afa9a', 'mental_disability', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''MI'')]', 'structured', 'secure/offenders/crn/$crn/all', null, false),
('10fca145-2451-4d18-8006-5e402db32032', 'progressive_disability', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''PC'')]', 'structured', 'secure/offenders/crn/$crn/all', null, false),
('4b3b2a12-4511-4a65-95b0-5506927da524', 'mobility_disability', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''RM'')]', 'structured', 'secure/offenders/crn/$crn/all', null, false),
('7461b171-b4d8-438d-a491-2aee4ac8a27a', 'physical_disability', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''RC'')]', 'structured', 'secure/offenders/crn/$crn/all', null, false),
-- ('5f965e7a-a17b-4ff2-aba4-d4d5f5c5b24c', 'apathy_disability', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''LD'')]', 'structured', 'secure/offenders/crn/$crn/all', null, false),
('889dc81f-7985-49c3-b395-4ade2bcd0181', 'disfigurement_disability', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''SD'')]', 'structured', 'secure/offenders/crn/$crn/all', null, false),
('5a6256f5-ed5b-4609-a208-6df04ff73e98', 'refuse_disability', 'UPW', 'DELIUS', '$.offenderProfile.disabilities[?(@.disabilityType.code==''RF'')]', 'structured', 'secure/offenders/crn/$crn/all', null, false),
