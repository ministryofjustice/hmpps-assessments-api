...
-- Add gp_name to the other_health_issues question group. NB: I've just used an arbitrary value for display order here as it's not used AFAIK
INSERT INTO question_group (question_group_uuid, content_uuid, content_type, group_uuid, display_order, read_only)
VALUES
('7d36a561-8138-423e-bcf4-29dfaa0bd690', '4b1e24af-6eb0-4d3c-add2-c6716878d480', 'question', 'dfa7b0e0-75a0-4117-ae0c-143c6ed97370', 24, false);