...
//
    ...
    fun calculateNeeds(@Parameter(description = "Supervision Id", required = true) @PathVariable supervisionId: String,
                       @Parameter(description = "Questions and answers for calculation", required = true) @RequestBody assessmentAnswersDto : AssessmentAnswersDto): CriminogenicNeedsDto {
        return criminogenicNeedsService.calculateNeeds(assessmentAnswersDto)
    }
}