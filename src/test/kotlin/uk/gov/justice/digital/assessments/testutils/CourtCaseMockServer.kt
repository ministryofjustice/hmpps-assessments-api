...
class CourtCaseMockServer : WireMockServer(9002) {
  fun stubCourtCase() {
    stubFor(
      WireMock.get(WireMock.urlEqualTo("/court/SHF06/case/existingAssessment"))
        .willReturn(
          WireMock.aResponse()
            .withHeaders(HttpHeaders(HttpHeader("Content-Type", "application/json")))
            .withBody(existingAssessmentCourtCaseJson)
        )
    )
  ...
  companion object {
    val existingAssessmentCourtCaseJson =
      """{
  "caseId": "951610",
  "caseNo": "existingAssessment",
  "courtCode": "SHF",
  "courtRoom": "06",
